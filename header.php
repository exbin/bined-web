...
<h4>&nbsp;&nbsp;&nbsp;Versions</h4>
<ul>
  <li><a href="<?php echo $parentPrefix; ?>editor">Editor</a></li>
  <li><a href="<?php echo $parentPrefix; ?>library">Component Libraries</a></li>
  <li><a href="<?php echo $parentPrefix; ?>basic-editor">Basic Editor</a></li>
  <li><a href="<?php echo $parentPrefix; ?>netbeans-plugin">NetBeans Plugin</a></li>
  <li><a href="<?php echo $parentPrefix; ?>intellij-plugin">IntelliJ Plugin</a></li>
  <li><a href="<?php echo $parentPrefix; ?>jdeveloper-extension">JDeveloper Extension</a></li>
</ul>

<h4>&nbsp;&nbsp;&nbsp;Documentation</h4>
<ul>
  <li><a href="<?php echo $rootPrefix; ?>?help">Help</a></li>
  <li><a href="<?php echo $rootPrefix; ?>?manual">Manual</a></li>
  <li><a href="<?php echo $parentPrefix; ?>javadoc">JavaDoc</a></li>
</ul>
